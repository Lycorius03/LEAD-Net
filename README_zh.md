...
详见 [`docs/CLOUD_TRAIN_GUIDE.md`](docs/CLOUD_TRAIN_GUIDE.md)。
...
| 文档 | 内容 |
|------|------|
| [docs/HANDOFF_GUIDE.md](docs/HANDOFF_GUIDE.md) | **从这里开始** — 完整项目交接指南 |
| [docs/CLOUD_TRAIN_GUIDE.md](docs/CLOUD_TRAIN_GUIDE.md) | 云端 RTX 5090 训练指南 |
| [docs/DEVLOG.md](docs/DEVLOG.md) | 开发者日志（按时间戳） |
| [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) | 架构设计 |
| [docs/RESEARCH_QUESTION.md](docs/RESEARCH_QUESTION.md) | 研究问题（RQ1-RQ5） |
| [docs/EXPERIMENTS.md](docs/EXPERIMENTS.md) | 实验记录 |
| [docxs/RESEARCH_YOLO11_LCA_UPGRADE.md](docxs/RESEARCH_YOLO11_LCA_UPGRADE.md) | YOLO11 上游调研 |
| [docxs/RESEARCH_MCU_DEPLOYABLE_DETECTORS.md](docxs/RESEARCH_MCU_DEPLOYABLE_DETECTORS.md) | MCU 可部署性调研 |
| [docxs/DESIGN_YOLO11_LCA.md](docxs/DESIGN_YOLO11_LCA.md) | 设计文档 + 双候选验证 |
